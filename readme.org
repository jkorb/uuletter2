#+TITLE:        =uuletter.cls= v.0.2.0 Readme
#+AUTHOR:      J. Korbmacher
#+DATE:        <2020-01-29 Wed>
...
(=uuletter.cls=) for writing letters that comply with the Utrecht
University (UU) Corporate Idenity.

The class is loaded like any other document class by means of the
command =\documentclass[<options>]{uuletter}=. For a description of
...
(=uuletter.cls=), the logos (with their original file names,
#+BEGIN_CENTER
=UU_logo_EN_CMYK.png= 
and
 =UU_logo_NL_CMYK.png=,
...
+ Put =uuletter.cls= in
#+BEGIN_CENTER
  =Users/<username>/Library/texmf/tex/latex/uuletter=
#+END_CENTER 
...
#+BEGIN_CENTER
  =Users/username/Library/texmf/tex/latex/uuletter/logos/=
#+END_CENTER
 Again, safe to create.
+ Put the signature file named =signature-uuletter.png= in
#+BEGIN_CENTER
  =Users/username/Library/texmf/tex/latex/uuletter/signature/=
#+END_CENTER
Also
